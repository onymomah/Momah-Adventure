...
const SPEEDSTOMPER_CHARACTERS = [
  { id: "spots_pointy", icon: "🐆🦏", label: "Spots & Pointy", tagline: "The fastest scout and the steadiest rhino. Together, nothing stops them.", group: "duo",
    ...
    villains: "The savanna itself is their biggest challenge: sudden sandstorms, flash floods, shifting terrain, lost animals, and ancient puzzles. Cackle and Snort (hyena brothers) sometimes cause mischief, but most stories focus on nature, friendship, and teamwork challenges.",
    tone: "High-energy adventure with heart and humor. Fast-paced but always lands on friendship and teamwork.",
    hooks: ["A baby zebra gets separated from the herd during a sandstorm. Spots scouts while Pointy carries it to safety.", "The main watering hole is drying up. The duo must find the ancient underground spring Zola told them about.", "Spots drinks too much Fizz-Berry juice and vibrates so fast he can't control his legs. Pointy has to handle a rescue mission alone.", "A mysterious sound echoes from the Rumble Hills every night. The duo investigates and discovers a trapped animal.", "Spots and Pointy disagree on how to cross a flooded river. They split up and both learn something."],
  ...
  { id: "hjg", icon: "🌈", label: "HummingJagmeleon", tagline: "You won't see me coming. You won't see me going. But you'll know I was there.", group: "squad",
    ...
    villains: "HJG's biggest challenges are personal: her color-shift glitching at the worst moment, overcoming her preference for silence to warn the team, and navigating places where invisibility doesn't help. Nature puzzles, lost creatures, and mysteries she must solve alone.",
    tone: "Mysterious, calm, slightly magical. Quiet and observant.",
    hooks: ["HJG's color shift gets stuck on bright pink while scouting a dangerous canyon. She has to complete the mission fully visible.", "A strange new plant is spreading across the savanna, changing the colors of everything it touches. HJG investigates.", "HJG finds a baby animal that can also camouflage. She teaches it to control its gift.", "A thick fog settles over the savanna and nobody can see. HJG must guide everyone using sound and touch instead of sight.", "HJG discovers ancient paintings in a hidden cave that tell the story of another creature like her."],
  ...
  { id: "digs", icon: "🐜", label: "Digs the Aardvark", tagline: "If you need to get under it, around it, or out from under it, I'm your aardvark.", group: "squad",
    ...
    villains: "Underground floods, cave-ins, hitting solid bedrock, and his own fear of wide-open spaces. His challenges are about courage, problem-solving in the dark, and helping friends from below when the surface world gets dangerous.",
    tone: "Gentle, humble, quietly heroic. Cozy underground feel.",
    hooks: ["A collapsed tunnel traps a family of ground squirrels. Digs has to dig a rescue shaft while keeping the ceiling stable.", "Digs discovers an underground river that could solve the dry-season water crisis. But the tunnel to it keeps flooding.", "A massive rainstorm threatens to flood Baobab Base from below. Digs must build a drainage system in record time.", "Digs finds glowing crystals deep underground and has to decide whether to tell everyone or protect the secret.", "Digs has to cross a wide-open plain to reach a friend in trouble. His biggest fear, his biggest moment."],
  ...
  { id: "prickle", icon: "🦔", label: "Prickle the Porcupine", tagline: "Got a problem? Give me sticks, vines, and five minutes. I'll build you a solution.", group: "squad",
    ...
    villains: "Her own inventions malfunctioning, impossible engineering problems, running out of materials, and the pressure of building something when lives depend on it. Her conflict is creative, not combative.",
    tone: "Cheerful, clever, STEM-adjacent. Building montage energy.",
    hooks: ["A bridge collapses and Prickle has to build a new one before the river rises. She has only vines and fallen branches.", "Prickle's latest invention works TOO well and she can't figure out how to turn it off.", "A young animal asks Prickle to build something impossible. She says yes anyway.", "Prickle loses all her tools in a flood and has to invent solutions using only what nature provides.", "Prickle and Nuru compete to build the best shelter before a storm. Both designs have flaws. They have to combine them."],
  ...
  { id: "cackle_snort", icon: "😂💤", label: "Cackle & Snort", tagline: "Why work hard when you can work sneaky? Also, can we nap first?", group: "villains",
    ...
    villains: "Their own incompetence is their villain. Stories from their perspective show their schemes going wrong, accidental heroism, and the rare moment of genuine friendship between the brothers.",
    tone: "Slapstick comedy. Villain perspective stories are told from THEIR point of view trying (and failing) to outsmart everyone.",
    hooks: ["Cackle accidentally saves a baby animal while trying to steal its food. He's confused about whether this makes him a hero.", "Snort finds the perfect warm rock for napping. Every animal in the savanna also wants it. Chaos ensues.", "Cackle tries to build a raft to cross the river. Snort sleeps through the entire construction. The raft sinks immediately.", "Snort has a dream where HE is the hero of the savanna. He wakes up and tries to be heroic for one day. It goes poorly.", "Cackle and Snort get lost in a fog and accidentally help a lost herd find their way home. They deny everything."],
  ...
  { id: "stretch", icon: "🦒", label: "Stretch the Giraffe", tagline: "See that far-off dust cloud? Let me take a closer look...", group: "allies",
    ...
    villains: "Low-hanging storm clouds that block his vision, terrain he can't navigate due to his height, and moments where seeing far isn't enough. His challenges test his gentleness, patience, and willingness to ask for help.",
    tone: "Calm, gentle, slightly poetic.",
    hooks: ["A dust storm reduces visibility to nothing. Stretch is the only one who can see above it and must guide everyone to shelter.", "Stretch spots a fire on the horizon. The team must organize an evacuation before it reaches the grasslands.", "A baby bird falls from a high nest. Stretch is the only one tall enough to return it, but the branch is fragile.", "Stretch gets his neck tangled in ancient vines and the team must carefully free him before sunset.", "Stretch notices the stars are in a pattern Zola once described. It leads to a hidden place no one has visited in decades."],
  ...
  { id: "swoop", icon: "🐦", label: "Swoop the Hornbill", tagline: "Package delivery? Message service? Distraction dive-bomb? I'm your bird!", group: "allies",
    ...
    villains: "Strong crosswinds, storms that ground him, and missions where flying isn't enough. His challenges test his bravery when he can't rely on the sky, and his loyalty when deliveries go wrong.",
    tone: "Energetic, proud, slightly show-offy.",
    hooks: ["Swoop's wing gets injured during a storm. He has to stay grounded and learn to help from below.", "A massive crosswind scatters Nuru's invention parts across the savanna. Swoop must retrieve every piece before nightfall.", "Swoop discovers a new water source from the air and leads the team on a long trek to reach it.", "Swoop has to deliver medicine to a sick animal on the far side of the Rumble Hills during a thunderstorm.", "Swoop tries to carry something too heavy and crash-lands in an unfamiliar part of the savanna. He has to find his way home on foot."],
  ...
  { id: "nuru", icon: "🐗", label: "Nuru the Warthog", tagline: "If you can dream it, I can build it. Probably. Give me a few tries.", group: "allies",
    ...
    villains: "His own inventions malfunctioning, impossible building challenges, time pressure, and the gap between his imagination and what savanna materials can actually do. His stories are about creative problem-solving under pressure.",
    tone: "Creative, optimistic, slightly chaotic. Invention montage energy.",
    hooks: ["The Baobab Base elevator breaks during a storm. Nuru has to build a temporary one from vines and giant leaves while everyone is stranded.", "Nuru invents a water-collecting device that works too well and accidentally creates a small lake where there wasn't one.", "Nuru tries to build a flying machine for Spots. Swoop watches skeptically. It almost works.", "A rockslide blocks the only path to the watering hole. Nuru has to engineer a new route using pulleys and ramps.", "Nuru teaches a group of young animals to build simple tools. Everything goes wonderfully wrong."],
  ...
  { id: "zola", icon: "🐘", label: "Zola the Elephant", tagline: "The savanna never forgets, and neither do I.", group: "allies",
    ...
    villains: "Time itself. Sandstorms that change the landscape and confuse her memory. The fear that the old ways are being forgotten. Her challenges are about preserving wisdom, guiding the young, and facing moments when even her vast memory isn't enough.",
    tone: "Wise, gentle, grand. Like sitting with a grandparent.",
    hooks: ["A drought threatens the savanna. Zola remembers an ancient underground spring, but the path to it has changed.", "Zola tells a bedtime story about the first animals who lived on the savanna. The story turns out to hold a clue the team needs.", "Zola's memory of one specific trail starts to fade. The team helps her retrace it before it's lost forever.", "Zola teaches the team to read the stars for navigation on a clear night. Each constellation has a story.", "A young elephant asks Zola why the savanna matters. Her answer becomes the most important story she's ever told."],
  ...
  { id: "snap", icon: "🐊", label: "Snap & The Sludge-Trudgers", tagline: "Fair play is for animals who can't win any other way.", group: "villains",
    ...
    villains: "His own ego and inability to work as a team. Stories from Snap's perspective show a competitive animal who keeps losing because he cheats instead of trying. Occasionally forced to cooperate with the Speedstompers when nature doesn't care about rivalries.",
    tone: "Competitive, sneaky, sports rivalry energy.",
    hooks: ["Snap challenges himself to win a race fairly for once. He almost makes it. Almost.", "A flash flood threatens both teams' territory. Snap has to ask the Speedstompers for help. He hates every second.", "Snap discovers a beautiful hidden lagoon and tries to keep it secret. Keeping secrets on the savanna is harder than he thought.", "Snap's crew quits on him after a scheme goes wrong. He has to do everything alone and realizes it's not fun.", "Snap accidentally does something genuinely kind and spends the whole story trying to convince everyone it was a scheme."],
